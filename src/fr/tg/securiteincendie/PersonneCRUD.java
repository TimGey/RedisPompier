    ...
    private void jButtonCommitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCommitActionPerformed
        ...
        try {
            ...
            for (int i = 0; i < liRows; i++) {
                ...
                System.out.println(i + " " + lsPersonne);
                if (lsFlag.equals("+")) {
...
//     
    ...
    private void jTablePersonnesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTablePersonnesMouseClicked
        ...
        for (int i = 0; i < jComboBoxCategories.getItemCount(); i++) {
            if (jComboBoxCategories.getItemAt(i).toString().equals(jTablePersonnes.getValueAt(jTablePersonnes.getSelectedRow(), 2).toString())) {
    ...
    private void jButtonModifierActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonModifierActionPerformed
        ...
        if (liRow >= 0) {
            if (jTablePersonnes.getValueAt(liRow, 0).toString().equals("") || jTablePersonnes.getValueAt(liRow, 0).toString().equals("-")||
                    jTablePersonnes.getValueAt(liRow, 0).toString().equals("v")) {
                jTablePersonnes.setValueAt("v", liRow, 0);
                jTablePersonnes.setValueAt(jTextFieldPersonne.getText(), liRow, 1);
                jTablePersonnes.setValueAt(jComboBoxCategories.getItemAt(jComboBoxCategories.getSelectedIndex()), liRow, 2);
            } else if (jTablePersonnes.getValueAt(liRow, 0).toString().equals("+")) {
                jTablePersonnes.setValueAt("+", liRow, 0);
                jTablePersonnes.setValueAt(jTextFieldPersonne.getText(), liRow, 1);
                jTablePersonnes.setValueAt(jComboBoxCategories.getItemAt(jComboBoxCategories.getSelectedIndex()), liRow, 2);
            }
        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PersonneCRUD.class
